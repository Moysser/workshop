...
class FormGroup extends HTMLElement {
  ...
  #handleBlur() {
    ...
    if (this.#input && !this.#input.validity.valid) {
      this.#errorMessage.textContent =
        this.#customErrorMessage[this.#getFirstInvalid(this.#input.validity)];
    }
  }
